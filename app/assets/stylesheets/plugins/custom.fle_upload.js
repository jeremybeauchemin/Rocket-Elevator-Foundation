		  ...
		  jQuery.fn.customFile = function() {
		    ...
		    return this.each(function() {
		      ...
		      var $file = jQuery(this).addClass('custom-file-upload-hidden'), // the original file input
		          ...
		          $button = jQuery('<span class="input-group-btn"><button type="button" class="file-upload-button btn btn-primary btn-primary-custom">' + jQuery(this).attr('data-btn-text') + '</button></span>'),
		          // Hack for IE
